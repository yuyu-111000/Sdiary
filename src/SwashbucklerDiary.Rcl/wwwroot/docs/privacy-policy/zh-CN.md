...
_Sdiray_ 是一款由 _Yu-Core（赵洪宇）_ （以下简称“我们”）提供的产品。 您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。 本《隐私政策》与您所使用的 _Sdiray_ 服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。

**您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。**

如对本《隐私政策》或相关事宜有任何问题，请通过 **yu-core@qq.com** 与我们联系。
...
- 相机权限
	...
	当您使用我们的服务更换头像、拍摄图片时，经您授权，我们会开启你的相机权限。您可以通过权限管理拒绝或关闭该权限。

- 存储权限

	当您使用我们的服务数据备份、导入导出、拍摄图片时，经您授权，我们会开启你的存储权限。您可以通过权限管理拒绝或关闭该权限。
